...
public class Z2Forwarder
{
    ...
    static final double reliability = 0.80; // NIEZAWODNOSC PRZEKAZYWANIA PAKIETU
    static final double duplicatePpb = 0.1; // PRAWDOPODOBIENSTWO ZDUPLIKOWANIA PAKIETU
    ...
    class Receiver extends Thread
    {
        ...
        {
            if(random.nextDouble() > reliability) // UTRATA PAKIETU
                return;
